		...
		<div class="teams-position">
			<table class="teams">
				<tr class="stat header">
					...
					<td class="teams-table-column">P/GP</td>
					<td class="teams-table-column">GF</td>
					<td class="teams-table-column">GA</td>
					<td class="teams-table-column">GD</td>
					<td class="teams-table-column">PP%</td>
					<td class="teams-table-column">PK%</td>
